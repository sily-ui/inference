<template>
  <div class="home-container">
    <!-- 顶部导航栏 -->
    <nav class="navbar">
      <div class="nav-brand">舆情推演平台</div>
      <div class="nav-links">
        <a href="https://github.com/sily-ui/inference" target="_blank" class="github-link">
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              即使只有一段文字，本平台也能基于其中的现实种子，全自动生成与之对应的至多<span class="highlight-orange">百万级Agent</span>构成的平行世界。通过上帝视角注入变量，在复杂的群体交互中寻找动态环境下的<span class="highlight-code">"局部最优解"</span>
            </p>
            <p class="slogan-text">
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">国内舆情平台模拟 & 自动解析预测需求 & 动态更新时序记忆</div>
                </div>
              </div>
              <div class="workflow-item">
...
import SocialDataSource from '../components/SocialDataSource.vue'
