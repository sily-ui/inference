  ...
  <div class="interaction-panel">
    ...
    <div class="main-split-layout">
      ...
      <div class="right-panel" ref="rightPanel">
        ...
        <div v-if="tokenStats" class="token-stats-dashboard">
          <div class="stats-header">
            <span class="stats-title">LLM 调用统计</span>
            <button class="stats-refresh" @click="fetchTokenStats" title="刷新">
              <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <div class="stats-cards">
            <div class="stats-card">
              <div class="stats-icon model">
                <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2">
                  <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/>
                </svg>
              </div>
              <div class="stats-info">
                <span class="stats-value">{{ tokenStats.model_name || '-' }}</span>
            ...
            <div class="stats-card">
              ...
              <div class="stats-info">
                <span class="stats-value">{{ (tokenStats.total_tokens || 0).toLocaleString() }}</span>
                <span class="stats-label">总Token</span>
              </div>
            </div>
            <div class="stats-card">
              ...
              <div class="stats-info">
                <span class="stats-value">{{ tokenStats.total_calls || 0 }}</span>
                <span class="stats-label">调用次数</span>
              </div>
            </div>
            <div class="stats-card">
              ...
              <div class="stats-info">
                <span class="stats-value">¥{{ tokenStats.estimated_cost || '0' }}</span>
                <span class="stats-label">预估费用</span>
              </div>
            </div>
          </div>
        </div>
...
import { chatWithReport, getReport, getAgentLog, getTokenStats } from '../api/report'
